...
class RestaurantDetailsView extends StatelessWidget {
  ...
  const RestaurantDetailsView({Key key, this.restaurant}) : super(key: key);
  ...
  Widget _buildDetails(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(
            '${S.of(context).restaurantPrice}${restaurant.priceDisplay}',
            style: style,
          ),
          SizedBox(width: 40),
          Text(
            '${S.of(context).restaurantPrice}${restaurant.rating.average}',
            style: style,
          ),
        ],
      ),
    ...
    return StreamBuilder<List<Restaurant>>(
      ...
      builder: (context, snapshot) {
        ...
        return FlatButton.icon(
          ...
          label: Text(S.of(context).restaurantFavourite),
        );
      },
    );
  }
